...
<html>
<head>
    <title>Four-Wheeler Student</title>
...
if (isset($_GET['duration']) && isset($_GET['std_id'])) {
    ...
    $selectUserSql = "SELECT * FROM student_table WHERE Std_id = '$std_id' AND Vehicle_Type = 'Four-wheeler'";
