...
<div class="purpose">
    ...
    <div class="details">
        ...
        $sql = "SELECT * FROM student_table WHERE Std_id = '$std_id' AND Vehicle_Type = 'Four-wheeler'";
        ...
        echo "<button class='book_now' onclick='bookSlot($std_id)'>Book Now</button>";
        ?>
...
<script>
    ...
    function bookSlot(stdId) {
        const selectedDuration = document.getElementById('durationDropdown').value;
        
        window.location.href = `booking_page3.php?duration=${selectedDuration}&std_id=${stdId}`;
    }
</script>
</body>
</html>
