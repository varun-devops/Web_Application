...
<html>
<head>
    <title>Two-Wheeler Faculty</title>
    <style>
        body {
...
<div class="purpose">
    ...
    <div class="details">
        ...
        $sql = "SELECT * FROM faculty_table WHERE Emp_Id = '$emp_id' AND Vehicle_Type = 'Two-wheeler'";
        ...
        if ($slot_no === null) {
            ...
            echo "<button class='book_now' onclick='bookSlot($slot_no, $floor, $emp_id)'>Book Now</button>";
            }
        ?>
    </div>
</div>
...
<script>
    ...
    function bookSlot(slotNo, floor, empId) {
        window.location.href = `booking_page.php?slot_no=${slotNo}&floor=${floor}&emp_id=${empId}`;
    }
</script>
</body>
</html>
